...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    FYTableViewController *ctr = [[FYTableViewController alloc] initWithStyle:UITableViewStylePlain];
...
/**
 NSArray *titleArr = @[@"Indeterminate mode",
 @"With label",
 @"With details label",
 @"Determinate mode",
 ...
 @"On window",
 @"NSURLSession",
 @"Determinate with NSProgress",
 @"Dim background",
 @"Colored"];
 NSArray *selectorArr = @[@"indeterminateExample",
 @"labelExample",
 @"detailsLabelExample",
 @"determinateExample",
